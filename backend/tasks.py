                    ...
                    if hours_worked >= 1:
                        ...
                        if enterprise:
                            ...
                            if enterprise.resource_type == 'wood':
                                enterprise.wood_stored += 1 #  enterprise.production_rate
                                logging.info(f"Added 1 wood to enterprise {enterprise.id}")
                            elif enterprise.resource_type == 'stone':
                                enterprise.stone_stored += 1 #  enterprise.production_rate
                                logging.info(f"Added 1 stone to enterprise {enterprise.id}")
                            ...
                            logging.info(f"Worker {worker.id} finished work at enterprise {enterprise.id}")
